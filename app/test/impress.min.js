...
(function (a, b) {
  ...
  s
    ? (q.classList.remove("impress-not-supported"), q.classList.add("impress-supported"))
  ...
  var t = {},
    ...
    w = (b.impress = function (c) {
      ...
      if (((c = c || "impress"), t["impress-root-" + c])) return t["impress-root-" + c];
      var r = {},
        w = null,
        x = null,
        y = null,
        ...
        H = function (a, b) {
          var c = a.dataset,
            d = {
              ...
              rotate: { x: f(c.rotateX), y: f(c.rotateY), z: f(c.rotateZ || c.rotate) },
              scale: f(c.scale, 1),
              el: a,
            };
          a.id || (a.id = "step-" + (b + 1)),
        ...
        I = function () {
          if (!D) {
            ...
            (b.content = "width=device-width, minimum-scale=1, maximum-scale=1, user-scalable=no"),
              b.parentNode !== a.head && ((b.name = "viewport"), a.head.appendChild(b));
            var g = B.dataset;
            (z = {
            ...
            e(B, k),
              e(B, { top: "50%", left: "50%", transform: n(z.perspective / A) + m(A) }),
              e(C, k),
        ...
        L = function (a, c) {
          ...
          w && (w.classList.remove("active"), q.classList.remove("impress-on-" + w.id)),
            a.classList.add("active"),
            q.classList.add("impress-on-" + a.id);
          var g = {
              rotate: { x: -d.rotate.x, y: -d.rotate.y, z: -d.rotate.z },
              translate: { x: -d.translate.x, y: -d.translate.y, z: -d.translate.z },
              scale: 1 / d.scale,
            },
            h = g.scale >= x.scale;
        ...
        a.addEventListener(
          ...
          a.addEventListener(
            ...
            function (b) {
              for (
                var c = b.target;
                (!c.classList.contains("step") || c.classList.contains("active")) &&
                c !== a.documentElement;
